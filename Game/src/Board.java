...
public class Board extends JPanel
{
 ...
 // private static final Color GRID_COLOR_A = new Color(84,137,139);
  ...
  private static final ImageIcon[] PIECES = new ImageIcon[12];     
  // String used to indicate each colour
  private static final String[] PIECE_NAMES = {"target", "target_filled","whiteknight","whitebishop","whiteking","whitequeen","blackpawn", "blackrook","blackknight","blackbishop","blackking","blackqueen"};
  ...
  public Board (int rows, int cols)
  {
	...
	PIECES [0] = new ImageIcon("target.png");
	PIECES [1] = new ImageIcon("target_filled.png");
	PIECES [2] = new ImageIcon("knightw.gif");
	PIECES [3] = new ImageIcon("bishopw.gif");
	PIECES [4] = new ImageIcon("kingw.gif");
	PIECES [5] = new ImageIcon("queenw.gif");
	PIECES [6] = new ImageIcon("pawnb.gif");
	PIECES [7] = new ImageIcon("rookb.gif");
	PIECES [8] = new ImageIcon("knightb.gif");
	PIECES [9] = new ImageIcon("bishopb.gif");
	PIECES [10] = new ImageIcon("kingb.gif");
    PIECES [11] = new ImageIcon("queenb.gif");
  ...
  /**
   * Convert a String to the corresponding ImageIcon defaulting to blank GIF 
